...
const faq = [
  {
    ...
    answer:
      "Für Motive: JPG, PNG, WEBP oder SVG. Für bereits fertige 3D-Modelle: STEP, STP, STL oder 3MF. Auch eine ZIP-Datei mit mehreren Dateien kann hochgeladen werden.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Per Überweisung auf Rechnung, zahlbar innerhalb von 14 Tagen nach Rechnungsstellung, sofern im Einzelfall nichts anderes vereinbart ist.",
  },
  {
    question: "Kann ich eine Bestellung widerrufen?",
    answer:
      "Grundsätzlich besteht ein 14-tägiges Widerrufsrecht. Individuell nach Motiv, Maßen oder Farbwünschen angefertigte 3D-Artworks sowie nach Kundenvorgaben konstruierte Sonderbauteile sind davon laut § 312g Abs. 2 Nr. 1 BGB ausgenommen, da sie eigens für die jeweilige Bestellung angefertigt werden.",
    linkTo: "/agb",
    linkLabel: "Vollständige Widerrufsbelehrung",
  },
  {
